...
const HeroSection = () => {
  return (
    <section className="hero-section text-white text-center">
      ...
      <p>Phantom Clean prides itself in being Melbourne’s best rated and most in demand cleaning company. We specialize in cleaning with exceptionally high attention to detail and 
